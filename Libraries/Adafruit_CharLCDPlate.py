...
class Adafruit_CharLCDPlate(Adafruit_I2C):
    ...
    def __init__(self, busnum=-1, addr=0x20, debug=False):
        ...
        self.i2c.bus.write_i2c_block_data(
          self.i2c.address, 0, 
          [ 0b11111111,   # IODIRA    R+G LEDs=outputs, buttons=inputs orig. 0b00111111
            self.ddrb ,   # IODIRB    LCD D7=input, Blue LED=output
            0b11111111,   # IPOLA     Invert polarity on button inputs orig. 0b00111111
            0b00000000,   # IPOLB
            ...
            0b00000000,   # IOCON
            0b00000000,   # IOCON
            0b11111111,   # GPPUA     Enable pull-ups on buttons orig. 0b00111111
            0b00000000,   # GPPUB
            0b00000000,   # INTFA
            0b00000000,   # INTFB
            0b00000000,   # INTCAPA
